...
call s:h("SpellBad", { "fg": s:red, "gui": "undercurl", "cterm": "undercurl" }) " Word that is not recognized by the spellchecker. This will be combined with the highlighting used otherwise.
